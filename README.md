...
### 👨🏻‍💻 Passos para Configuração
 ...
 ```bash
	git clone https://github.com/arthurgcorreia/cy-e2eburguer.git 
```
...
-   **Login com perfil salão**:
	 -  Tenta logar com perfil salão e direciona para página de info para fluxo do app.    
			  
    
      ### Demonstração 
    [Testes de Login](https://github.com/user-attachments/assets/375b51d8-fb8b-4125-a260-07031eee2ff5)
...
## 📌 Notas Gerais
Feito com ❤️ por [Arthur Gonçalves](https://github.com/arthurgcorreia) 😊
